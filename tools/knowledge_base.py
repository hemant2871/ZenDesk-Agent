...
def search_knowledge_base(query: str) -> str:
    """Search the internal knowledge base for articles relevant to a customer support query.
    Use this tool first before composing any response to a ticket.
    Input should be the customer's question or issue description as a plain string."""
    try:
        top_k = TOP_K
